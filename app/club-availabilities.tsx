...
export default function ClubAvailabilities() {
  ...
  const { fieldId, fieldName, startDate, endDate, startTime, endTime } = useLocalSearchParams(); 
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={{flex: 1, marginLeft: 15}}>
            ...
            {startTime && endTime ? (
                <Text style={styles.subtitle}>Showing {startTime} - {endTime}</Text>
            ) : (
                <Text style={styles.subtitle}>Select consecutive blocks</Text>
            )}
        </View>
      </View>
      ...
      {selectedSlots.length > 0 && (
          <View style={styles.bottomBar}>
              <View style={{flex: 1}}>
                  ...
                  <Text style={styles.durationText}>{selectedSlots.length * 30} minutes total</Text>
              </View>
